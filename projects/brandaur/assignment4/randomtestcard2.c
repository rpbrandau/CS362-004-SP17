...
1: Current player draws one card (implemented)
2: One card should come from current player's draw pile (implemented)
3: Current player's hand should increase (duplicate of 1:)
4: Current player's ACTIONS should increase by 2 (implemented)
...
int main()
{
	...
	for(loopCounter = 0; loopCounter < 2000; loopCounter++)
	{
		...
		//G.hand[numPlayers][cardPos] = village; //give the player a village card. Not sure if needed, since we just call its card effect.
